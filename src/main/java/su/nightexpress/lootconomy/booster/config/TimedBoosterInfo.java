...
public class TimedBoosterInfo extends BoosterInfo {
    ...
    public TimedBoosterInfo(@NotNull Set<String> skills,
    ...
    @NotNull
    public static TimedBoosterInfo read(@NotNull JYML cfg, @NotNull String path) {
        ...
        return new TimedBoosterInfo(skills, multiplier, startTimes, duration);
    }
