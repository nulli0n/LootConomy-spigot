...
public class PlayerSkillLevelUpEvent extends PlayerSkillEvent {

    private static final HandlerList handlerList = new HandlerList();

    public PlayerSkillLevelUpEvent(@NotNull Player player, @NotNull LootUser user, @NotNull SkillData data) {
