...
public class PlayerSkillXPGainEvent extends PlayerSkillXPEvent {

    private static final HandlerList handlerList = new HandlerList();

    public PlayerSkillXPGainEvent(@NotNull Player player, @NotNull LootUser user, @NotNull SkillData data,
