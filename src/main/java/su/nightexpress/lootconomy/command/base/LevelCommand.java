...
public class LevelCommand extends AbstractCommand<LootConomy> {

    public LevelCommand(@NotNull LootConomy plugin) {
        super(plugin, new String[]{"level"}, Perms.COMMAND_LEVEL);
        this.setDescription(plugin.getMessage(Lang.COMMAND_LEVEL_DESC));
        this.setUsage(plugin.getMessage(Lang.COMMAND_LEVEL_USAGE));
    ...
    protected void onExecute(@NotNull CommandSender sender, @NotNull CommandResult result) {
        ...
        skillData.setLevel(mode.modify(skillData.getLevel(), amount));
        skillData.normalize();
